...
class Bot(TelegramObject):
    ...
    Attributes:
        id (:obj:`int`): Unique identifier for this bot.
        first_name (:obj:`str`): Bot's first name.
        last_name (:obj:`str`): Optional. Bot's last name.
        username (:obj:`str`): Bot's username.
        name (:obj:`str`): Bot's @username.
