...
class MessageEntity(TelegramObject):
    ...
    Attributes:
        ...
        MENTION (:obj:`str`): 'mention'
        HASHTAG (:obj:`str`): 'hashtag'
        BOT_COMMAND (:obj:`str`): 'bot_command'
        URL (:obj:`str`): 'url'
        EMAIL (:obj:`str`): 'email'
        BOLD (:obj:`str`): 'bold'
        ITALIC (:obj:`str`): 'italic'
        CODE (:obj:`str`): 'code'
        PRE (:obj:`str`): 'pre'
        TEXT_LINK (:obj:`str`): 'text_link'
        TEXT_MENTION (:obj:`str`): 'text_mention'
        ALL_TYPES (List[:obj:`str`]): List of all the types.
